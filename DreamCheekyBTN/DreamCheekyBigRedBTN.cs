...
namespace DreamCheekyUSB {
	public class DreamCheekyBigRedBTN  {
        ...
        public DreamCheekyBigRedBTN() : this(0)
        {
			ActivatedMessage = Messages.BUTTON_PRESSED;
		}

		public DreamCheekyBigRedBTN(int deviceIndex = 0) : this(DEFAULT_VENDOR_ID, DEFAULT_PRODUCT_ID, deviceIndex) {
			ActivatedMessage = Messages.BUTTON_PRESSED;
		}

		public DreamCheekyBigRedBTN(int vendorID, int productID, int deviceIndex = 0){
		...
		public DreamCheekyBigRedBTN(string devicePath) {
